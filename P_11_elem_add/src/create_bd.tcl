# ==============================================================
# create_bd.tcl - Block Design: Zynq PS + AXI DMA + elem_add_stream
# ZedBoard (xc7z020clg484-1)
#
# Arquitectura:
#   Zynq PS -> AXI DMA (32-bit stream) -> elem_add_stream -> AXI DMA -> DDR
#   ARM escribe pares (a,b) INT8 empaquetados en 32 bits,
#   DMA los envia, elem_add procesa, DMA escribe resultado.
# ==============================================================

create_bd_design "zynq_ea_bd"
...
read_vhdl [file join $src_dir elem_add_stream.vhd]
...
# elem_add_stream (nuestro modulo RTL)
create_bd_cell -type module -reference elem_add_stream elem_add_stream_0
...
connect_bd_net [get_bd_pins ps7/FCLK_CLK0] \
    ...
    [get_bd_pins elem_add_stream_0/clk] \
...
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
    ...
    [get_bd_pins elem_add_stream_0/resetn]
...
# DMA Stream -> elem_add_stream -> DMA
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] \
    [get_bd_intf_pins elem_add_stream_0/s_axis]
connect_bd_intf_net [get_bd_intf_pins elem_add_stream_0/m_axis] \
...
# Wrapper
make_wrapper -files [get_files zynq_ea_bd.bd] -top
set bd_dir [file dirname [get_files zynq_ea_bd.bd]]
set wrapper_file [file normalize "$bd_dir/hdl/zynq_ea_bd_wrapper.v"]
add_files -norecurse $wrapper_file
set_property top zynq_ea_bd_wrapper [current_fileset]
update_compile_order -fileset sources_1

puts "OK: Block Design 'zynq_ea_bd'"
puts "  - Zynq PS + DMA (32-bit stream)"
puts "  - elem_add_stream (layer_017 params hardcoded)"
puts "  - 4 DSP48E1 (2x mul_s9xu30_pipe x 2 ramas)"
