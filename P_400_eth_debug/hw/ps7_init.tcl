...
proc ps7_clock_init_data_3_0 {} {
    ...
    mask_write 0XF800012C 0x01FFCCCD 0x016C044D
    mwr -force 0XF8000004 0x0000767B
}
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF8006018 0xF7FFFFFF 0x452464D3
    ...
    mask_write 0XF800612C 0x000FFFFF 0x00027003
    mask_write 0XF8006130 0x000FFFFF 0x00026403
    mask_write 0XF8006134 0x000FFFFF 0x0001DC00
    mask_write 0XF8006138 0x000FFFFF 0x0001E400
    ...
    mask_write 0XF800616C 0x001FFFFF 0x000000EE
    mask_write 0XF8006170 0x001FFFFF 0x000000CC
    mask_write 0XF8006174 0x001FFFFF 0x000000CE
...
proc ps7_peripherals_init_data_3_0 {} {
    ...
    mask_write 0XE000A204 0xFFFFFFFF 0x00000280
    mask_write 0XE000A000 0xFFFFFFFF 0xFF7F0080
    mask_write 0XE000A208 0xFFFFFFFF 0x00000280
