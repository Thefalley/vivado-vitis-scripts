# ==============================================================
# run_safe.tcl - Programa + ejecuta + verifica via JTAG
# P_102 bram_ctrl_v2: counter test
# Handles DAP errors with system reset
# Uso: xsct run_safe.tcl <bitstream.bit> <elf_file> <fsbl.elf>
# ==============================================================
...
# First, try a system reset to clear DAP errors
puts "\nIntentando system reset ..."
catch {
...
# Re-connect and re-scan
puts "Re-scanning after system reset ..."
catch {disconnect}
after 1000
connect
after 3000
...
# Re-scan
puts "Re-scanning despues de FPGA ..."
catch {disconnect}
after 1000
connect
after 3000
