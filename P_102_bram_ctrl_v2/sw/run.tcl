...
# Test parameters (must match the C app)
...
# ==============================================================
# VERIFICACION POR JTAG: read DDR markers + data + AXI-Lite regs
# ==============================================================
puts "\n========================================="
...
# ==============================================================
# Read AXI-Lite counter registers directly via JTAG
# ==============================================================
# NOTE: The CTRL_BASE address depends on Vivado address mapping.
# Typically bram_ctrl_top_0 S_AXI is at 0x43C00000 (M01 of GP0 IC).
# We try to read it; if it fails we skip.
...
if {[catch {
    ...
    puts "  (Counters should be 0 after final reset)"
} err]} {
    puts "  WARN: Could not read AXI-Lite registers at $ctrl_base"
    puts "        ($err)"
    puts "        Counter readback via JTAG skipped"
}
