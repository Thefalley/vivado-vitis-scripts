...
#
# P_102: bram_ctrl_v2 with occupancy/total counters + AXI-Lite readback
#
# Arquitectura:
...
read_vhdl [file join $src_dir axi_lite_cfg_rw.vhd]
...
# ==============================================================
# 4. bram_ctrl_top (our RTL module, v2 with counters)
# ==============================================================
...
puts "OK: Block Design 'bram_ctrl_bd' creado (P_102 v2 con contadores)"
puts "  - Zynq PS con DDR (512MB)"
puts "  - AXI DMA (MM2S + S2MM)"
puts "  - bram_ctrl_top v2 (occupancy + total_in/out counters)"
