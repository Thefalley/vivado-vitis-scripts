/* =========================================================================
 * Auto-generated IC-tiling variant of layer_005
 *   c_in           = 3
 *   ic_tile_size   = 2
 *   num tiles      = 2
 *   last tile size = 1
...
int main(void)
{
    ...
    xil_printf("  IC TILING: ic_tile_size=2, 2 tile(s), c_in=3\r\n");
    ...
    conv_write(REG_IC_TILE_SIZE, 2); /* IC tiling variant: 2 tile(s) over c_in=3 */
