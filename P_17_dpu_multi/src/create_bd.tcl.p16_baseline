...
#     DMA MM2S lee DDR[src_addr] --> AXI-Stream --> conv_stream_wrapper s_axis (LOAD)
#
#   Data path (output):
#     conv_stream_wrapper m_axis (DRAIN) --> DataMover S_AXIS_S2MM --> DDR[dest_addr]
#     dm_s2mm_ctrl genera cmd 72-bit --> DataMover S_AXIS_S2MM_CMD
#
#   Control path:
#     ARM configura conv via AXI-Lite (conv_stream_wrapper)
...
# ==============================================================
# 5. conv_stream_wrapper (module reference - conv_engine_v3 inside)
# ==============================================================
...
# --- DMA MM2S -> conv_stream_wrapper s_axis (LOAD data into BRAM) ---
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] \
    [get_bd_intf_pins conv_stream_wrapper_0/s_axis]

# --- conv_stream_wrapper m_axis -> DataMover S_AXIS_S2MM (DRAIN output) ---
...
# --- Generate wrapper ---
make_wrapper -files [get_files conv_dm_bd.bd] -top
set bd_dir [file dirname [get_files conv_dm_bd.bd]]
set wrapper_file [file normalize "$bd_dir/hdl/conv_dm_bd_wrapper.v"]
add_files -norecurse $wrapper_file
set_property top conv_dm_bd_wrapper [current_fileset]
update_compile_order -fileset sources_1

puts "============================================================"
puts "OK: Block Design 'conv_dm_bd' created"
...
puts "  - conv_stream_wrapper (conv_engine_v3 + AXI-Stream)"
