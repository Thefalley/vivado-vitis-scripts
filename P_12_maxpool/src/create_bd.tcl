# Block Design: Zynq PS + AXI DMA + maxpool_stream

create_bd_design "zynq_mp_bd"

set proj_dir [get_property DIRECTORY [current_project]]
set src_dir [file normalize [file join $proj_dir ../src]]

read_vhdl [file join $src_dir maxpool_unit.vhd]
read_vhdl [file join $src_dir maxpool_stream.vhd]
...
create_bd_cell -type module -reference maxpool_stream maxpool_stream_0
...
connect_bd_net [get_bd_pins ps7/FCLK_CLK0] \
    ...
    [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins maxpool_stream_0/clk] \
...
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] \
    [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins maxpool_stream_0/resetn]
...
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins maxpool_stream_0/s_axis]
connect_bd_intf_net [get_bd_intf_pins maxpool_stream_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
...
make_wrapper -files [get_files zynq_mp_bd.bd] -top
set bd_dir [file dirname [get_files zynq_mp_bd.bd]]
add_files -norecurse [file normalize "$bd_dir/hdl/zynq_mp_bd_wrapper.v"]
set_property top zynq_mp_bd_wrapper [current_fileset]
update_compile_order -fileset sources_1

puts "OK: Block Design zynq_mp_bd"
