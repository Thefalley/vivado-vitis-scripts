...
XAxiDma_Config XAxiDma_ConfigTable[XPAR_XAXIDMA_NUM_INSTANCES] =
{
	...
	{
		XPAR_AXI_DMA_W_DEVICE_ID,
		XPAR_AXI_DMA_W_BASEADDR,
		XPAR_AXI_DMA_W_SG_INCLUDE_STSCNTRL_STRM,
		XPAR_AXI_DMA_W_INCLUDE_MM2S,
		XPAR_AXI_DMA_W_INCLUDE_MM2S_DRE,
		XPAR_AXI_DMA_W_M_AXI_MM2S_DATA_WIDTH,
		XPAR_AXI_DMA_W_INCLUDE_S2MM,
		XPAR_AXI_DMA_W_INCLUDE_S2MM_DRE,
		XPAR_AXI_DMA_W_M_AXI_S2MM_DATA_WIDTH,
		XPAR_AXI_DMA_W_INCLUDE_SG,
		XPAR_AXI_DMA_W_NUM_MM2S_CHANNELS,
		XPAR_AXI_DMA_W_NUM_S2MM_CHANNELS,
		XPAR_AXI_DMA_W_MM2S_BURST_SIZE,
		XPAR_AXI_DMA_W_S2MM_BURST_SIZE,
		XPAR_AXI_DMA_W_MICRO_DMA,
		XPAR_AXI_DMA_W_ADDR_WIDTH,
		XPAR_AXI_DMA_W_SG_LENGTH_WIDTH
	}
};
