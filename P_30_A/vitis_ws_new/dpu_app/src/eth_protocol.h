 ...
 *
 * Copied from P_18, unchanged. Used by P_30_A eth_server.
 */
...
/* ============================================================================
 * Extension V0+: layer_cfg_t + EXEC_LAYER real.
 * ========================================================================= */
...
/* Direcciones acordadas del mapa de memoria */
...
/* CRC32 IEEE 802.3 (mismo que zlib.crc32) */
