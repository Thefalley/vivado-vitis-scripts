...
if os.path.exists(os.path.join(ws_dir, "conv_pynq_platform")):
    ...
    sys.exit(0)
client = vitis.create_client(workspace=ws_dir)
p = client.create_platform_component(name="conv_pynq_platform", hw_design=xsa_path, os="standalone", cpu="ps7_cortexa9_0")
p.build()
xpfm = os.path.join(ws_dir, "conv_pynq_platform", "export", "conv_pynq_platform", "conv_pynq_platform.xpfm")
