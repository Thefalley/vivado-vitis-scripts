# ==============================================================
# create_bd.tcl - Block Design: Zynq PS + AXI DMA + DDR
...
#   AXI DMA: M_AXIS_MM2S --> S_AXIS_S2MM (loopback para test)
#
# Flujo: ARM escribe datos en DDR, DMA los lee (MM2S), loopback,
#         DMA los escribe en otra posicion (S2MM). ARM verifica.
# ==============================================================
...
# UART1 on MIO 48-49 (ZedBoard USB-UART)
set_property -dict [list \
    CONFIG.PCW_UART1_PERIPHERAL_ENABLE {1} \
    CONFIG.PCW_UART1_UART1_IO {MIO 48 .. 49} \
] $zynq

# FCLK_CLK0 at 100 MHz
set_property -dict [list \
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100} \
] $zynq

# Enable AXI GP0 (master, for controlling DMA via AXI-Lite)
# Enable AXI HP0 (slave, for DMA to access DDR)
...
# ==============================================================
# 2. AXI DMA (Simple DMA, no Scatter-Gather)
# ==============================================================
...
# GP0 interconnect: Zynq GP0 master -> DMA S_AXI_LITE
...
# HP0 interconnect: DMA MM2S/S2MM masters -> Zynq HP0 slave (DDR)
...
# --- DMA Stream Loopback (MM2S -> S2MM) ---
connect_bd_intf_net [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] \
    [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]

# --- Interrupts: DMA mm2s + s2mm -> concat -> Zynq ---
...
# Generate wrapper
make_wrapper -files [get_files zynq_dma_bd.bd] -top
set bd_dir [file dirname [get_files zynq_dma_bd.bd]]
set wrapper_file [file normalize "$bd_dir/hdl/zynq_dma_bd_wrapper.v"]
add_files -norecurse $wrapper_file
set_property top zynq_dma_bd_wrapper [current_fileset]
update_compile_order -fileset sources_1

puts "OK: Block Design 'zynq_dma_bd' creado"
puts "  - Zynq PS con DDR (512MB)"
puts "  - AXI DMA (MM2S + S2MM, SG deshabilitado)"
puts "  - Loopback: MM2S stream -> S2MM stream"
puts "  - Interrupts conectadas a IRQ_F2P"
puts "  - UART1 habilitado (USB-UART)"
