...
# Test parameters (must match the C app loaded)
...
# Re-scan JTAG chain after FPGA programming (fixes DAP errors)
targets
after 1000
...
# Wait for app to finish (incremental test takes longer)
after 15000
stop
...
# Read source and dest buffers from DDR
puts "  Leyendo DDR ..."
...
if {$errors == 0} {
    ...
    puts "  bram_ctrl_top FIFO + DMA FUNCIONA"
} else {
