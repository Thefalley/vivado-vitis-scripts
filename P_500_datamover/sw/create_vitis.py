...
print("[3/4] Creando app dm_test ...")
xpfm_path = os.path.join(ws_dir, "dm_study_platform", "export", "dm_study_platform", "dm_study_platform.xpfm")
